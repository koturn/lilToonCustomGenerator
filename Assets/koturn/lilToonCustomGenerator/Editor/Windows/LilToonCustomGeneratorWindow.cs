...
namespace Koturn.LilToonCustomGenerator.Editor.Windows
{
    ...
    public sealed class LilToonCustomGeneratorWindow : EditorWindow
    {
        ...
        /// </summary>
        private Dictionary<string, string> _defaultTextCacheDict;
        /// <summary>
        /// Custom shader name.
        /// </summary>
        ...
        /// <summary>
        /// <para>Called after <see cref="Awake"/> and after compilation.</para>
        /// <para>Initialize non serializable members.</para>
        /// </summary>
